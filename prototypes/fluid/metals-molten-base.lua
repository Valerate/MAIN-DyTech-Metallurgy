...
{
  {
    ...
    icon = "__MAIN-DyTech-Metallurgy__/graphics/fluid/molten-copper.png",
    order = "copper",
  ...
  },
  {
    ...
    icon = "__MAIN-DyTech-Metallurgy__/graphics/fluid/molten-iron.png",
    order = "iron",
    pressure_to_speed_ratio = 0.4,
    flow_to_energy_ratio = 0.59,
    subgroup = "metallurgy-fluid-metal-basic",
  },
  {
    ...
    base_color = {r=185, g=188, b=192},
    flow_color = {r=185, g=188, b=192},
    icon = "__MAIN-DyTech-Metallurgy__/graphics/fluid/molten-carbonated-iron.png",
