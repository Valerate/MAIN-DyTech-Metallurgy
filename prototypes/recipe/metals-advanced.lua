data:extend(
{
  ...
  {
    type = "recipe",
    name = "metallurgy-stellite-alloy",
	enabled = false,
	category = "forge",
    energy_required = 1.5,
    ingredients =
    ...
    results = 
	{
      {type="item", name="stellite-alloy", amount=1}
    },
  },
  {
    type = "recipe",
    name = "metallurgy-titanium-aluminide-alloy",
	enabled = false,
	category = "forge",
    energy_required = 1.5,
    ingredients =
    ...
    results = 
	{
      {type="item", name="titanium-aluminide-alloy", amount=1}
    },
  },
  {
    type = "recipe",
    name = "metallurgy-solder-alloy",
	enabled = false,
	category = "forge",
    energy_required = 1.5,
    ingredients =
